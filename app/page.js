...
export default function Home() {
  return (
    <main className="bg-sky-500 flex min-h-screen min-w-full px-7 sm:px-20 mx-auto flex-col flex-wrap items-center justify-between">
      <section className="maintop flex md:flex-row flex-wrap justify-between w-full  sm:px-28 sm:mx-auto sm:my-[3rem]">
        <div className="flex flex-col name-box text-center mx-1 ml-2">
          ...
          <Image src={jsloon}
            ...
            className="jsloon animate-[balloon1_10s_infinite] w-[5rem] mx-1 sm:mx-2"
            
          />
          <Image src={reactloon}
            alt="Picture of React logo imposed onto a balloon"
            className="reactloon animate-[balloon2_10s_infinite] w-[5rem] mx-1 sm:mx-2"
            
          />
          <Image src={mongoloon}
            alt="Picture of mongoDB logo imposed onto a balloon"
            className="mongoloon animate-[balloon1_10s_infinite] w-[5rem] mx-1 sm:mx-2"
            
          />
          <Image src={nodeloon}
            alt="Picture of nodejs logo imposed onto a balloon"
            className="nodeloon animate-[balloon2_10s_infinite] w-[5rem] mx-1 sm:mx-2"
