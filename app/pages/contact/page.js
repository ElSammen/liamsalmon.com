            ...
            <section className="maintop flex md:flex-row flex-wrap justify-center w-full gap-28 px-28 sm:mx-auto sm:my-[3rem] text-center md:text-left">
                ...
                <div className="rightside flex justify-center">
                    <div className="flex border-4 border-black bg-orange-400 shadow-[8px_8px_0px_rgba(0,0,0,1)] px-12 h-[8rem] relative my-3 justify-center place-content-center" >
                        ...
                        <div className="flex flex-row justify-center justify-self-center gap-3 align-items-center my-[20%]">
